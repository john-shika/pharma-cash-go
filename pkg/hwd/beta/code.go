...
// WARN: this is useless, barcodes not giving any symbol type

// CodeTyped describes the type of the scanned symbol
type CodeTyped int

const (
	Code128 CodeTyped = iota
	Code39
	Code2of5
	Codabar
	DataMatrix
...
// NewCode returns a new Code struct from a scanned byte array
func NewCode(input []byte) (*Code, error) {
