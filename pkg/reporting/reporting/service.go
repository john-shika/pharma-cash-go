...
func PdfService(config *pdf.PdfConfig) {
...
func XlsxService(config *xlsx.XlsxConfig) {
	doc := xlsx.NewDocXlsx(config)

	doc.Sheet1Print("Sheet1", &xlsx.FormDataXlsx{}, xlsx.Sheet1TableRowsXlsx{})
	doc.Sheet2Print("Sheet2", &xlsx.FormDataXlsx{}, xlsx.Sheet2TableRowsXlsx{})
